...
public class RancherBuilder extends AbstractRancherBuilder {
    ...
    public RancherBuilder(
            ...
            String image, boolean confirm, boolean startFirst, String ports, String environments, int timeout, String dataVolumes) {
    ...
    protected static RancherBuilder newInstance(String environmentId, String endpoint, String credentialId, String service,
        ...
        RancherBuilder rancherBuilder = new RancherBuilder(environmentId, endpoint, credentialId, service, image, confirm, startFirst, ports, environments, timeout, dataVolumes);
    ...
    public void perform(@Nonnull Run<?, ?> build, @Nonnull FilePath workspace, @Nonnull Launcher launcher, @Nonnull TaskListener listener) throws InterruptedException, IOException {
        ...
        listener.getLogger().printf(environments.toString());
